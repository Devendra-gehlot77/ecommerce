                ...
                <div className="container py-5">
                    <div className="row g-4">
                        ...
                        <div className="col-lg-3 col-md-6">
                            ...
                            <ul className="list-unstyled">
                                <li className="mb-2"><Link to={'/contact-us'} className="text-decoration-none text-muted">Contact Us</Link></li>
                                <li className="mb-2"><Link to={'/shipping-policy'} className="text-decoration-none text-muted">Shipping Policy</Link></li>
                                <li className="mb-2"><Link to={'/return-exchange'} className="text-decoration-none text-muted">Returns & Exchanges</Link></li>
