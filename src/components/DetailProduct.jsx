        ...
        <div className="row g-4">
          ...
          <div className="col-md-6">
            ...
            <h4 className=" my-3">
              {" "}
              <strong>PRICE:</strong>
              <span className="text-success"> ${productDetails.price}</span>
            </h4>
            ...
            <div className="mb-3 d-flex   gap-1 ">
              <h4>
                ...
                <span className="text-success ">{productDetails.rating}</span>
              </h4>

              {ratingDetail.map((value, index) => (
                <i
                  className="fa fa-star text-warning fs-5  mt-1 ms-2 "
                  key={index}
                ></i>
              ))}
            </div>
